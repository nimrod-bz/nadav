...
class Jet_Tabs_Widget extends Jet_Tabs_Base {
	...
	protected function render() {
		...
		$tabs_position_tablet = ! empty ( $tabs_position_tablet ) ? $tabs_position_tablet : $tabs_position;
		$tabs_position_mobile = $this->get_settings( 'tabs_position_mobile' );
		$tabs_position_mobile = ! empty ( $tabs_position_mobile ) ? $tabs_position_mobile : $tabs_position_tablet;
		...
		$settings = array(
			...
			'tabsPositionTablet' => $tabs_position_tablet,
			'tabsPositionMobile' => $tabs_position_mobile,
		);
