		...
		showVariationImage: function ( variation ) {
			...
			$.each($product_gallery, function () {
				...
				var sliderItemsCount = $gallerySlider.find( '.jet-woo-product-gallery__image-item' ).length,
					sliderFeaturedItemsCount = $gallerySlider.find( '.jet-woo-product-gallery__image-item.featured' ).length;

				if ( $swiperSetting && $swiperSetting['loop'] && sliderItemsCount > sliderFeaturedItemsCount ) {
