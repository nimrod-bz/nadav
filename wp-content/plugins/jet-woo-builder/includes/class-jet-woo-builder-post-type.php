...
if ( ! class_exists( 'Jet_Woo_Builder_Post_Type' ) ) {
	...
	class Jet_Woo_Builder_Post_Type {
		...
		public function set_body_class( $classes ) {
			...
			if ( is_singular( $this->slug() ) && jet_woo_builder()->documents->is_document_type('single') ) {
		...
		public function set_post_class( $classes ) {
			...
			if ( is_singular( $this->slug() ) && ( jet_woo_builder()->documents->is_document_type('single') || jet_woo_builder()->documents->is_document_type('archive') ) ) {
				$classes[] = 'product';
			}
